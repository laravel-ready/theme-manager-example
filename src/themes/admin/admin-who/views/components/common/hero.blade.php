        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="ud-hero-brands-wrapper wow fadeInUp" data-wow-delay=".3s">
                    <img src="@asset(images/hero/brand.svg" alt="brand)" />
                </div>
                <div class="ud-hero-image wow fadeInUp" data-wow-delay=".25s">
                    <img src="@asset(images/hero/hero-image.svg" alt="hero-image)" />
                    <img src="@asset(images/hero/dotted-shape.svg" alt="shape" class="shape shape-1)" />
                    <img src="@asset(images/hero/dotted-shape.svg" alt="shape" class="shape shape-2)" />
                </div>
            </div>
        </div>
    </div>
