...
<div class="container relative">
    <div class="flex items-center justify-between py-6">
        <a href="#">
            <img class="block w-8 h-8" src="@asset('images/logo.svg')" alt="" />
        </a>
        <a href="#">
        ...
        <div class="flex items-center mb-4 md:block">
            <a class="mr-8 font-semibold hover:text-white" href="#">Documentation</a>
    ...
    <h1 class="px-8 mt-16 mb-4 text-5xl font-extrabold leading-tight text-center text-white xl:text-6xl">
        ...
        <span class="text-indigo-700">startups</span>
    </h1>
    ...
    <div class="flex flex-col justify-center max-w-xs mx-auto mb-12 sm:max-w-full sm:flex-row">
        ...
        <a class="w-full mb-4 whitespace-no-wrap bg-gray-800 btn btn-tall md:w-auto hover:bg-gray-600 sm:ml-2" href="#">
            View on Github
        </a>
    </div>
    <div class="mb-16">
        <img class="block w-full max-w-5xl mx-auto rounded" src="@asset('images/video-placeholder.jpg')" alt="" />
    </div>
    <div>
        ...
        <ul class="flex flex-col flex-wrap justify-center mb-20 text-center border-b border-gray-900 sm:flex-row">
            <li class="w-full px-6 mb-8 sm:mb-16 md:w-1/2 lg:w-1/3">
                <span
                    ...
                    <img src="@asset('images/feature-tile-icon-01.svg')" alt="" />
                </span>
            ...
            <li class="w-full px-6 mb-8 sm:mb-16 md:w-1/2 lg:w-1/3">
                <span
                    class="flex items-center justify-center w-16 h-16 mx-auto mb-4 text-3xl text-white bg-indigo-700 rounded-full">
                    <img src="@asset('images/feature-tile-icon-02.svg')" alt="" />
                </span>
                <h3 class="mb-2 text-2xl font-bold text-white">
                    Robust Workflow
                </h3>
            ...
            <li class="w-full px-6 mb-8 sm:mb-16 md:w-1/2 lg:w-1/3">
                <span
                    class="flex items-center justify-center w-16 h-16 mx-auto mb-4 text-3xl text-white bg-indigo-700 rounded-full">
                    <img src="@asset('images/feature-tile-icon-03.svg')" alt="" />
                </span>
                <h3 class="mb-2 text-2xl font-bold text-white">
                    Robust Workflow
                </h3>
            ...
            <li class="w-full px-6 mb-8 sm:mb-16 md:w-1/2 lg:w-1/3">
                <span
                    class="flex items-center justify-center w-16 h-16 mx-auto mb-4 text-3xl text-white bg-indigo-700 rounded-full">
                    <img src="@asset('images/feature-tile-icon-04.svg')" alt="" />
                </span>
            ...
            <li class="w-full px-6 mb-8 sm:mb-16 md:w-1/2 lg:w-1/3">
                <span
                    class="flex items-center justify-center w-16 h-16 mx-auto mb-4 text-3xl text-white bg-indigo-700 rounded-full">
                    <img src="@asset('images/feature-tile-icon-05.svg')" alt="" />
                </span>
                <h3 class="mb-2 text-2xl font-medium text-white">
                    Robust Workflow
                </h3>
            ...
            <li class="w-full px-8 mb-8 sm:mb-16 md:w-1/2 lg:w-1/3">
                <span
                    class="flex items-center justify-center w-16 h-16 mx-auto mb-4 text-3xl text-white bg-indigo-700 rounded-full">
                    <img src="@asset('images/feature-tile-icon-06.svg')" alt="" />
                </span>
                <h3 class="mb-2 text-2xl font-medium text-white">
                    Robust Workflow
                </h3>
    ...
    <div class="mb-16 border-b border-gray-800">
        ...
        <div class="flex flex-col mb-8 sm:flex-row">
            <div class="flex items-center mb-8 sm:w-1/2 md:w-5/12 sm:order-last">
                <img class="rounded-sm" src="@asset('images/features-split-image-01.png')" alt="" />
            </div>
        ...
        <div class="flex flex-col mb-8 sm:flex-row">
            <div class="flex items-center mb-8 sm:w-1/2 md:w-5/12">
                <img class="rounded-sm" src="@asset('images/features-split-image-02.png')" alt="" />
            </div>
        ...
        <div class="flex flex-col mb-8 sm:flex-row">
            <div class="flex items-center mb-8 sm:w-1/2 md:w-5/12 sm:order-last">
                <img class="rounded-sm" src="@asset('images/features-split-image-03.png')" alt="" />
            </div>
            <div class="flex flex-col justify-center mb-8 sm:w-1/2 md:w-7/12 sm:pr-16">
                <p class="mb-2 text-sm font-semibold leading-none text-center text-indigo-600 uppercase sm:text-left">
                    Lightning fast workflow
    ...
    <div class="mb-16">
        ...
        <p class="intro mx-auto sm:max-w-xl">
    ...
    <div class="flex flex-col items-center px-4 py-8 mb-16 bg-indigo-700 bg-right-bottom bg-no-repeat bg-cover sm:flex-row sm:py-16 sm:px-12"
        style="background-image: url('@asset('images/features-split-image-03.png')')">
        <h2
        ...
        <div class="flex flex-grow w-full sm:w-2/3 md:w-1/2 lg:w-5/12">
            <form class="flex items-center w-full p-4 bg-white rounded-sm space-between" action="#">
                ...
                <svg class="text-indigo-700 fill-current" width="16" height="12" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="flex flex-col items-center sm:flex-row sm:justify-between">
        <a class="text-indigo-700" href="#">
            <img src="@asset('logo.svg')" alt="" class="mx-auto mb-4" />
        </a>
    ...
    <div class="flex flex-col justify-between mb-8 text-center sm:flex-row">
        <p class="order-last mb-4 text-sm text-gray-500 sm:order-first">
            Designed by
            <a href="https://cruip.com/" class="text-white">Cruip</a>.
            Coded by
